			...
			<div class="footer-top-inner">
				<?php if (!empty(\ishop\App::$app->getProperty('settings')['logo_footer'])): ?>
					...
					<div class="footer-top-contacts">
									...
									<div class="all-contacts">
										...
										<?php if (!empty($phones)): ?>
											...
											<?php foreach ($phones as $phone): ?>
												...
												<a class="link" href="tel:<?= $phone['link'] ?>"
						...
						<div class="callback">
							<a href="#modalFeedback" class="btn-gradient" data-toggle="modal-new"
							   data-feedback="Заказать звонок: подвал">Заказать звонок</a>
						</div>
	...
	<div class="footer-center">
		<div class="container">
			<div class="footer-center-inner">
				<div class="footer-center-info footer-center-schedule">
					
					<div class="schedule">
						<div class="title">Время работы офиса</div>
						<div class="text">
							<?= \ishop\App::$app->getProperty('settings')['schedule_office'] ?>
						</div>
					</div>
				...
				<div class="footer-center-catalog">
					...
					<?php if (!isset($_GET['catalog'])) {
						new \app\widgets\menu\Menu([
							...
							'container' => 'div',
							'class' => 'footer-center-catalog-list',
						]);
					} ?>
				</div>
				
				<div class="footer-center-info footer-center-nav">
					<div class="schedule">
	...
	<div class="footer-bottom">
		...
		<div class="footer-bottom-inner">
			<div class="container">
				...
				<ul class="list">
					<a href="<?= PATH ?>/page/podacha-obrascheniya">Подача обращения</a>
					<a href="<?= PATH ?>/page/politika-obrabotki-personal-nyh-dannyh">Политика конфиденциальности</a>
				</ul>
			</div>
		</div>
	</div>
