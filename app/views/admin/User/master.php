  <section class="content-header">
      <h1>
          Список пользователей со статусом "мастер"
      </h1>
      <ol class="breadcrumb">
          <li><a href="<?=ADMIN;?>"><i class="fa fa-dashboard"></i> Главная</a></li>
          <li class="active">Список пользователей со статусом "мастер"</li>
      </ol>
  </section>
                  ...
                  <div class="box-body">
                      <div class="table-responsive">
                        ...
                        <div class="prod_state_buttons" style="display:flex; align-items:center; margin-bottom:10px;">
                          <a style="margin-right: 20px;" href="<?=ADMIN;?>/user" class="btn btn-primary">Все пользователи</a>
                          <a style="margin-right: 20px;" href="<?=ADMIN;?>/user/opt" class="btn btn-primary">Оптовики</a>
                          <a style="margin-right: 20px;" class="btn btn-default">Мастера</a>
