  <section class="content-header">
      <h1>
          Список пользователей со статусом "клиент"
      </h1>
      <ol class="breadcrumb">
          <li><a href="<?=ADMIN;?>"><i class="fa fa-dashboard"></i> Главная</a></li>
          <li class="active">Список пользователей со статусом "клиент"</li>
      </ol>
  </section>
                  ...
                  <div class="box-body">
                      <div class="table-responsive">
                        ...
                        <div class="prod_state_buttons" style="display:flex; align-items:center; margin-bottom:10px;">
                          ...
                          <a style="margin-right: 20px;" class="btn btn-default">Клиенты</a>
                        </div>
