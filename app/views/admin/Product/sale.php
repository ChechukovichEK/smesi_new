                ...
                <div class="box-body">
                    <div class="table-responsive">
                      <div class="prod_state_buttons" style="display:flex; align-items:center; margin-bottom:10px;">
                        ...
                        <p style="margin-right: 20px;" class="btn btn-default">Акция</p>
                        <a style="margin-right: 20px;" href="<?=ADMIN;?>/product/hide" class="btn btn-primary">Скрытые товары</a>
