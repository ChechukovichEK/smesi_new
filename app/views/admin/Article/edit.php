                ...
                <form action="<?= ADMIN; ?>/article/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea name="content" id="editor1" rows="10" cols="80"><?= $new->content; ?></textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                <div class="box box-primary box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        <div id="newsimg" class="btn btn-success" data-url="/article/add-image"
                                             data-name="newsimg">Выбрать файл
                                        </div>
                                        <p><small>Рекомендуемые размеры: 300*200</small></p>
                                        <div class="newsimg">
                                            <img src="<?= PATH; ?>/images/<?= $new->img ?>" style="max-height:150px;"
