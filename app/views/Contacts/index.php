	...
	<div class="container">
    	...
    	<div class="pages-contacts">
			...
			<div class="pages-contacts-right">
				...
				<p>Здравствуйте! Меня зовут Сергей Сергеевич Сергеев, я директор компании Smesi.by Вам нужны специальные цены? У Вас есть предложения или вопросы? Пожалуйста, свяжитесь со мной!</p>
				...
				<form method="post" onsubmit="ym(98576053,'reachGoal','call_back'); return true;">
					...
					<input name="tel_cent" placeholder="Ваш телефон" required="" type="text" />
