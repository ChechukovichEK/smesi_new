<div class="pages-content svp">
	...
	<div id="svpForm" class="cta">
			...
			<div class="cta-content">
				<div class="cta-description">
					<div class="title">Свяжитесь с нами для обсуждения индивидуального прайса. <br>
						Гарантируем гибкие и прозрачные условия работы для будущих партнеров</div>
				</div>
				<form action="/feedback/send" method="post" class="cta-form" data-ajax-form
					...
					<div class="group">
						...
						<div class="action">
							<button class="btn-gradient" type="submit">Запросить цены</button>
		...
		<picture class="cta-bg">
			<img class="image" src="<?= PATH ?>/img/svp/contact-form-bg.png" data-no-webp>
		</picture>
